...
type RouteTab = "workspace" | "system" | "tools" | "navigation" | "ai" | "image-workbench" | "settings" | "file-manager" | "playground" | "utils-docs";
...
const currentTab = computed<RouteTab>(() => {
  ...
  if (name === "system" || name === "tools" || name === "navigation" || name === "ai" || name === "image-workbench" || name === "settings" || name === "file-manager" || name === "playground" || name === "utils-docs") {
