...
export const utilityDocs: UtilityDocEntry[] = [
  ...
  doc({
    ...
    description: "剪贴板复制结果、降级来源、错误报告和展示文本。",
      functions: ["copyTextToClipboard", "createClipboardCopyResult", "summarizeClipboardCopyResult", "createClipboardCopyReport", "formatClipboardCopyResult"],
  ...
  doc({
    ...
    functions: ["normalizeSearchKeywordText", "rankSearchItemsWithSummary", "partitionSearchQuery", "createSearchResultDisplaySummary"],
