...
const componentGroups: ComponentGroup[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { key: "choice-controls", name: "BaseSelect / BaseSegmented / BaseCheckbox / BaseRadioGroup / BaseSwitch", title: "选择开关", description: "下拉、分段、勾选、单选、开关和禁用态。" },
      ...
      { key: "tag-input", name: "BaseTagInput", title: "标签输入", description: "添加、粘贴、折叠、拖拽、去重、重复、清空和状态。" },
      ...
      { key: "date-range", name: "BaseDateRange", title: "日期范围", description: "时间筛选、快捷范围、周起始、错误态和禁用态。" },
