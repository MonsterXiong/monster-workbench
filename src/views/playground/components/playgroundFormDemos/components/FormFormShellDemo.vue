    ...
    <PlaygroundDemoSection title="表单容器" subtitle="把表单标题、字段布局和尾部动作区收在一个基础组件里。" icon="FileText">
      <div class="form-demo-stack">
        ...
        >
          ...
          <template #footer>
            <BaseFormActions title="实例方法" description="通过 ref 调用 validate、resetFields 和 clearValidate。" :divided="false">
              <BaseButton type="neutral" size="sm" @click="clearPlaygroundValidation">清空校验</BaseButton>
